    ...
    <main>
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <h3 class="pull-left" style="color: #0d6efd;">Liste salles</h3>
                    </div>
                    <hr>
                    <div class="form-group" align="right" style="padding-bottom: 1%;">
                        <a href="ajoutEtuidSocl.php" class="btn btn-success"><i class="fa fa-plus"></i> Salle</a>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-striped" id="table">
                        <thead>
                            <tr>
                                <th style='width: 90%;'>Salle</th>
                                <th style='width: 10%;'></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
                            if ($result =  mysqli_query($conn, "select * from salle order by id desc")) {
