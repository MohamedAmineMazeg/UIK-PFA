    ...
    <main>
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <h3 class="pull-left" style="color: #0d6efd;">Liste des examens de l'année scolaire <?php echo $anneeScolaire ?></h3>
                        <!--." du ". $semestre-->
                    </div>
                    <hr>
                    <div class="form-group" align="right" style="padding-bottom: 1%;">
                        <a href="ajoutEtuidSocl.php" class="btn btn-success"><i class="fa fa-plus"></i> Examen</a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-striped" id="table">
                        <thead>
                            <tr>
                                ...
                                <th style='width: 10%;'>Type d'examen</th>
                        ...
                        <tbody>
                            <?php
                            if ($result =  mysqli_query($conn, "select * from v_examen order by id desc")) {
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        echo "<tr>";
                                        echo "<td>" . $row['cour_libelle'] . "</td>";
                                        echo "<td>" . $row['type_examen_libelle'] . "</td>";
                                        echo "<td>" . $row['prenom'] . " " . $row['nom'] . "</td>";
                                        echo "<td>" . $row['libelle_niveau'] . " " . $row['groupe_libelle'] . "</td>";
                                        echo "<td>" . $row['semester_libelle'] . "</td>";
                                        echo "<td>" . $row['salle_libelle'] . "</td>";
                                        echo "<td>" . date("d/m/Y", strtotime($row['dt_examen'])) . " à " . $row['dt_debut'] . "H -- " . $row['dt_fin'] . "H</td>";
                                        echo "<td>";
