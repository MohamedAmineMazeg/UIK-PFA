...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($inputLibelle) && !empty($inputNmbExper)) {
        ...
        $sql = "UPDATE .experience SET libelle=" . '"' . $libelle . '"' . ", experience=$experience WHERE id=$id;";
    ...
    if (isset($_GET["id"]) && !empty(trim($_GET["id"]))) {
        if ($result =  mysqli_query($conn, "SELECT * FROM experience where id=" . $id)) {
                ...
                <form method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-2">
                            <input type="button" value="Annuler" class="btn btn-danger" onclick="window.location='editProfileProf.php?id=<?php echo $idUser ?>';">
