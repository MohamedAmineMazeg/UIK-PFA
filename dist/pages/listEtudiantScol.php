    ...
    <main>
        <div class="wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <h3 class="pull-left" style="color: #0d6efd;">Liste des étudiants</h3>
                    </div>
                    <hr>
                    <div class="form-group" align="right" style="padding-bottom: 1%;">
                        <a href="ajoutEtuidSocl.php" class="btn btn-success"><i class="fa fa-plus"></i> Etudiant</a>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered table-striped" id="table">
                        ...
                        <tbody>
                            <?php
                            if ($result =  mysqli_query($conn, "select * from v_etudiant order by id desc ")) {
                                if (mysqli_num_rows($result) > 0) {
                                    while ($row = mysqli_fetch_array($result)) {
                                        echo "<tr>";
                                        echo "<td>" . $row['prenom'] . " " . $row['nom'] . "</td>";
                                        echo "<td>" . $row['libelle_specialite'] . "</td>";
                                        echo "<td>" . $row['libelle_niveau'] . " " . $row['libelle_barche'] . "</td>";
