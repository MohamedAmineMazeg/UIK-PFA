...
if (plus1) {
  plus1.addEventListener('click', () => {
    solu1.classList.toggle('solu');
  });
}
plus2.addEventListener('click', () => {
  solu2.classList.toggle('solu');
});
plus3.addEventListener('click', () => {
  solu3.classList.toggle('solu');
});
plus4.addEventListener('click', () => {
  solu4.classList.toggle('solu');
});
plus5.addEventListener('click', () => {
  solu5.classList.toggle('solu');
});
plus6.addEventListener('click', () => {
  solu6.classList.toggle('solu');
});
